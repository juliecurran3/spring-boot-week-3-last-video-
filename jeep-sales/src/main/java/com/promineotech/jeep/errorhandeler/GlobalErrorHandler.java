package com.promineotech.jeep.errorhandeler;
...
public class GlobalErrorHandler {
  ...
  public Map<String, Object> handelMethodArgumentTypeMismatchException(
  ...
  @ResponseStatus(code = HttpStatus.NOT_FOUND ) //overrides the 200 error code 
  public Map<String, Object> handleNoSuchElementException(
      NoSuchElementException e, WebRequest webRequest) { // get u.r.i add an extra p.aram
      return createExceptionMessage(e, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
   } // modified the method to add  webRequest
